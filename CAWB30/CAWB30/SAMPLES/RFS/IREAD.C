...
void main(void)
{
   ...
   /*************************************************************************/
   printf("Reading 676 records, key = AA -> ZZ\n");
   while(!rc)
   {
   ...
   /*************************************************************************/
   printf("Reading by key, key = XX\n");
   rc = RealiaFSReadKey(&handle, 1, "XX", RFSLOCK_NO, &bytes_read);
   if(rc)
   {
