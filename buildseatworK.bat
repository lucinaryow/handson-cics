...
rem Generate Sample System Maps
if exist SW004.bin erase SW004.bin
if exist SW004.cob erase SW004.cob
rem Generate Sample System Maps
if exist SW005.bin erase SW005.bin
if exist SW005.cob erase SW005.cob
rem Generate Sample System Maps
...
rem Generate Sample System Maps
if exist SW12.bin erase SW12.bin
if exist SW12.cob erase SW12.cob
set _step=3
call bms sm000s
if errorlevel 1 goto builderr
...
if errorlevel 1 goto builderr
rem Generate Sample System Programs: Translate, Compile, and Link
if exist SM012.dll erase SM012.dll
if exist SM012.obj erase SM012.obj
call cicstran SM012 /hvw
if errorlevel 1 goto builderr
call bms SW12
if errorlevel 1 goto builderr
rem Generate Sample System Programs: Translate, Compile, and Link
